  ...
  return (
    <Accordion>
      ...
      <Accordion.Item eventKey='1'>
        ...
        <Accordion.Body>
          You can start a free trial which is 7 days. After that with cost will
          be as little as $5.99 a month!
        </Accordion.Body>
      </Accordion.Item>
      ...
      <Accordion.Item eventKey='3'>
        ...
        <Accordion.Body>
          You can sign up today and start watching your favorite shows and
          movies!
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
